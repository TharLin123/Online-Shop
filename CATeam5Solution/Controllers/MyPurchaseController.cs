    ...
    public class MyPurchaseController : Controller
    {
       private DBContext dbContext;
        ...
        public IActionResult MyPurchase()
        {
            ...
            Users user = dbContext.Users.FirstOrDefault(x => x.UserName == "adam");
            Guid userid = user.Id;
            
            List<Order> orders = dbContext.Orders.Where(x => x.UsersId == userid).ToList();
            ...
            ViewData["orderhistory"] = orders;//主要从这里获取订单时间 可以展示该商品最后购买时间
