    ...
    public partial class InitialCreate1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActCode", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ActCode_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActCode_Products_ProductsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductsShoppingCart", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductsShoppingCart_Products_ProductsId",
                        column: x => x.ProductsId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductsShoppingCart_ShoppingCart_ShoppingCartId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActCode_OrderId",
                table: "ActCode",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_ActCode_ProductsId",
                table: "ActCode",
                column: "ProductsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductsShoppingCart_ProductsId",
                table: "ProductsShoppingCart",
                column: "ProductsId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductsShoppingCart_ShoppingCartId",
                table: "ProductsShoppingCart",
                column: "ShoppingCartId");

            migrationBuilder.CreateIndex(
                name: "IX_Session_UsersId",
                table: "Session",
                column: "UsersId");
